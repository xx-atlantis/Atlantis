...
export default function ShopBannerAdmin() {
  ...
  const save = async () => {
    setSaving(true);
    try {
      // image and brand are shared — copy from en to ar
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {field("en", "heroImage", "Banner Image URL", "/shop-banner.jpg")}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
            ...
            <p className="text-xs text-gray-400">Brand name and image URL are shared between both languages.</p>
          </div>
        </div>
      )}
    </main>
