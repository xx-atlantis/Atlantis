    ...
    <div className="min-h-screen bg-white font-sans flex flex-col items-center justify-center p-6">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-red-50 border border-red-100 rounded-lg p-6 font-mono text-sm shadow-sm">
          ...
          <pre className="text-gray-500 space-y-1 overflow-x-auto whitespace-pre-wrap break-all text-xs">
            <code>
              {`at initializeData (./lib/db/connection.js:42:12)\nat async RootLayout (./app/layout.js:15:3)`}
            </code>
            {"\n"}
            <span className="text-red-400">--- stack trace truncated ---</span>
            {"\n\n"}
        ...
        <div className="mt-8 border-t border-gray-100 pt-6">
          <p className="text-xs text-gray-400 leading-relaxed text-center">
            This error occurred during the execution of your application.
            <br />
